...
smk_dir = "test_data/out"

# Not configurable
fs_observer_dir = Path(smk_dir) / "runs"
data_root = "/home/adminuser/backup/work_directory/zenodo/"

group_by = "test_data/supplementary_table_73.ods"
preprocessing_log = smk_dir + "preprocessing_log.csv"
file_stats_freq = "test_data/statistics_v2.csv"
# Configurable
...
rule split_data:
    ...
    shell:
        "python data_splitting.py {input} {output} {params.num_trials} --file_indices {params.file_indices}"
